...
return array(
	'ServerAddress'				=> '52.221.92.166',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
//'ServerAddress'				=> '127.0.0.1:81',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
//   'BaseURI'					=> '/fluxcp',						// The base URI is the base web root on which your application lies.
  ...
  'InstallerPassword'			=> 'secretpassword',		// Installer/updater password.
    ...
    'ThemeName'					=> array('bootstrap', 'default'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
    ...
    'PayPalBusinessEmail'		=> 'lancerace-facilitator@hotmail.com',		// Enter the e-mail under which you have registered your business account.
